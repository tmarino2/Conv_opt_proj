...
of our objective
\begin{equation}
  {\cal L}\left(W, \Theta, H) = ||X - W\Theta H||_F^2 + \lambda ||\Theta||_1 - \sum_{i=1}^m \sum_{j=1}^m \mu_{ij} W_{ij} - \sum_{i=1}^m \sum_{j=1}^n \nu_{ij} H_{ij} - \sum_{i=1}^n \xi \Theta_{ii}.
\end{equation}

The augmented Lagrangian, in contrast, considers the following objective
\begin{equation}
  {\cal L}\left(W, \Theta, H) = ||X - W\Theta H||_F^2 + \lambda ||\Theta||_1 - \sum_{i=1}^m \sum_{j=1}^m \max(0, -W_{ij} + \frac{\mu_{ij}}{\rho})^2  - \sum_{i=1}^m \sum_{j=1}^n \nu_{ij} H_{ij} - \sum_{i=1}^n \xi \Theta_{ii}.
\end{equation}
...
\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-alpha.png}
  \caption{Our objective varying $\alpha$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-lambda.png}
  \caption{Our objective varying $\lambda$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-eta.png}
  \caption{Our objective varying $\eta$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-internal-W.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $W$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-internal-H.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $H$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-internal-Th.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $\theta$}
\end{figure}


\begin{figure}
  \includegraphics[width=\textwidth]{decrease-step-all.png}
  \caption{All steps from alternating minimization problem concatenated together}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{sda-lambda.png}
  \caption{Objective with varying $\lambda$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{sda-eta.png}
  \caption{Objective with varying $\eta$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{sda-internal-W.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $W$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{sda-internal-H.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $H$}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{sda-internal-Th.png}
  \caption{Every 10\textsuperscript{th} of our convex internal problem optimizing $\theta$}
\end{figure}
