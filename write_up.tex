...
\begin{figure}[H]
  ...
  \caption{Experimental results from decreasing step sized for projected gradient decent running $\alpha \in \{0.001, 0.05, 0.1, 0.5\}, \eta \in \{ 0.01, 0.1, 0.5, 1, 10 \}, \lambda \in \{ 0.01, 0.1, 0.5, 1, 10\} $.
    %
    With the decreasing step size, we observe that the objectives of even our worst behaved
  }
\end{figure}
...
\begin{center}
  \begin{figure}[h]
    \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=0.01,eta0.01}.pdf}
    \caption{$\lambda=0.01,\eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=0.01,eta1.0}.pdf}
    \caption{$\lambda=0.01,\eta=1.0$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=0.5,eta0.1}.pdf}
    \caption{$\lambda=0.5 \eta=0.1$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=1.0,eta0.01}.pdf}
    \caption{$\lambda=1.0 \eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=1.0,eta0.5}.pdf}
        \caption{$\lambda=1.0 \eta=0.5$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/W:lambda=1.0,eta1.0}.pdf}
...
\begin{center}
  \begin{figure}[h]
    \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=0.01,eta0.01}.pdf}
    \caption{$\lambda=0.01,\eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=0.01,eta1.0}.pdf}
    \caption{$\lambda=0.01,\eta=1.0$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=0.5,eta0.1}.pdf}
    \caption{$\lambda=0.5 \eta=0.1$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=1.0,eta0.01}.pdf}
    \caption{$\lambda=1.0 \eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=1.0,eta0.5}.pdf}
        \caption{$\lambda=1.0 \eta=0.5$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/H:lambda=1.0,eta1.0}.pdf}
    \caption{$\lambda=1.0 \eta=1.0$}
  \end{subfigure}
\end{figure}
\end{center}
...
\begin{center}
  \begin{figure}[h]
    \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=0.01,eta0.01}.pdf}
    \caption{$\lambda=0.01,\eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=0.01,eta1.0}.pdf}
    \caption{$\lambda=0.01,\eta=1.0$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=0.5,eta0.1}.pdf}
    \caption{$\lambda=0.5 \eta=0.1$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=1.0,eta0.01}.pdf}
    \caption{$\lambda=1.0 \eta=0.01$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=1.0,eta0.5}.pdf}
        \caption{$\lambda=1.0 \eta=0.5$}
  \end{subfigure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[scale=0.1]{{augmented-lagrangian/plots/theta:lambda=1.0,eta1.0}.pdf}
    \caption{$\lambda=1.0 \eta=1.0$}
  \end{subfigure}
\end{figure}
\end{center}
